...
class OrderGeneralProductContainer extends StatelessWidget {
  ...
  final String title;
  final String img;
  OrderGeneralProductContainer({super.key,this.productsorderamount =0, required this.isQtyReq,this.count=0,this.productid='',required this.title,required this.uid,required this.img});
