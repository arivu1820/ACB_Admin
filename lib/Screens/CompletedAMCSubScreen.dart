...
class CompletedAMCSubScreen extends StatefulWidget {
  @override
  State<CompletedAMCSubScreen> createState() => _CompletedAMCSubScreenState();
}

class _CompletedAMCSubScreenState extends State<CompletedAMCSubScreen> {
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        body: StreamBuilder<QuerySnapshot>(
          stream: _firebaseService.getCompletedAMCSubscription(),
              ...
              subs.sort((a, b) {
                ...
                if (claimedA != claimedB) {
                  ...
                  if (isDoneA == isDoneB) {
                    ...
                    return (createdAtB as Timestamp)
                        .compareTo(createdAtA as Timestamp);
                  } else {
